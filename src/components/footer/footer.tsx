                    ...
                    <Center className="">
                        <VStack>
                            <Text
                                  ...
                                  fontSize={"15px"} 
                                  color={"white.half"} 
                                  mb={"10px"}>{(!isLogin) ? "No pierdas la oportunidad de ver a tu artista favorito de manera facil y segura!" : "¿Tienes una entrada que no usaras o que te sobra? Anúnciala y véndela de manera rápida y segura"}</Text>
