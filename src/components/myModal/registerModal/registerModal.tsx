...
export const RegisterModal = (props: Props) => {
    ...
    const bodyComponents = () => {
        ...
        return  <VStack gap={3} alignItems={"start"}>
                    ...
                    <Checkbox {...register("termsConditionsAccept", {required: "Aceptar los términos y condiciones es obligatorio"})}><Link href="/terminos-condiciones" fontSize={"16px"} isExternal>Acepta los términos y condiciones</Link></Checkbox>
